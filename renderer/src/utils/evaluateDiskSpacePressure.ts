...
const DISK_PRESSURE_WARNING_MESSAGE =
  'Места на диске может не хватать для импорта. Очистите корзину, удалите ненужные файлы или перенесите папку «Библиотека ARC» на другой диск средствами системы, затем укажите путь в настройках.';

const DISK_PRESSURE_CRITICAL_MESSAGE =
  'На диске почти не осталось места. Срочно освободите место, очистите корзину ARC или перенесите папку «Библиотека ARC» на другой диск средствами системы, затем укажите путь в настройках.';
