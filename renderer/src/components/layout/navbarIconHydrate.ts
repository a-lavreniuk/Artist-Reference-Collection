...
const ICON_FILES: Record<IconKey, string> = {
  ...
  chevronsCollapse: 'chevrons-collapse_m.svg',
  check: 'check_m.svg',
  ...
  textShort: 'text-short_m.svg',
  textarea: 'textarea_m.svg',
  checkCircle: 'check-circle_m.svg',
  list: 'list_m.svg',
  listCheck: 'list-check_m.svg'
};
...
const ICON_CLASS_TO_KEY: Record<string, IconKey> = {
  ...
  arc_icon_chevrons_collapse: 'chevronsCollapse',
