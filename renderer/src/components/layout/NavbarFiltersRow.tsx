...
export default function NavbarFiltersRow() {
  ...
  return (
    ...
    >
      <button type="button" className="btn btn-outline btn-ds btn-m arc-navbar-filter-sort" disabled aria-disabled="true">
      ...
      <div className="btn-group btn-group-ds arc-navbar-filters-options">
        <button type="button" className="btn btn-ds btn-m btn-icon-only" disabled aria-label="Список фильтров" aria-disabled="true">
          <span className="btn-icon-only__glyph arc-icon-filter-list" aria-hidden="true" />
        </button>
        <button type="button" className="btn btn-ds btn-m btn-icon-only" disabled aria-label="Пресеты" aria-disabled="true">
          <span className="btn-icon-only__glyph arc-icon-save" aria-hidden="true" />
        </button>
        <button type="button" className="btn btn-ds btn-m btn-icon-only" disabled aria-label="Очистить фильтры" aria-disabled="true">
