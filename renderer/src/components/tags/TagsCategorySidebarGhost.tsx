import type { TagsCategoryDragState } from './useTagsCategoryDrag';

type Props = {
  dragState: TagsCategoryDragState;
};

export default function TagsCategorySidebarGhost({ dragState }: Props) {
  return (
    <div
