...
export default function OnboardingLayout({ children, className, standalone = false }: Props) {
  useEffect(() => {
    ...
    if (standalone) {
      body.classList.add('arc-onboarding-standalone');
      html.classList.add('arc-onboarding-standalone');
    }
    ...
    return () => {
      html.style.height = '';
      body.style.height = '';
      body.classList.remove('arc-onboarding-page', 'arc-onboarding-standalone');
      html.classList.remove('arc-onboarding-page', 'arc-onboarding-standalone');
