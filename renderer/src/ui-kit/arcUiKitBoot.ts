...
export function mountArcUiKitDemo(scope: HTMLElement, options?: { signal?: AbortSignal }): void {
  ...
  const docOpts = { signal: mountAc.signal } as AddEventListenerOptions;
      ...
      const INPUT_GLYPH_INLINE = {
        ...
        "close_m.svg":
          '<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M11.1461 4.14613L8.00005 7.2922L4.85398 4.14613C4.65878 3.95094 4.34215 3.95108 4.14687 4.14613C3.95161 4.34139 3.95161 4.65797 4.14687 4.85324L7.29294 7.99931L4.14618 11.1461C3.95093 11.3413 3.95093 11.6579 4.14618 11.8532C4.34145 12.0482 4.65808 12.0484 4.85329 11.8532L8.00005 8.70642L11.1468 11.8532C11.3421 12.0483 11.6587 12.0484 11.8539 11.8532C12.0489 11.658 12.049 11.3413 11.8539 11.1461L8.70716 7.99931L11.8532 4.85324C12.0485 4.65799 12.0485 4.3414 11.8532 4.14613C11.658 3.95107 11.3413 3.95095 11.1461 4.14613Z" fill="currentColor"/></svg>',
        "close_s.svg":
          '<svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8.14611 3.14608L5.99924 5.29295L3.85306 3.14677C3.65779 2.95151 3.34121 2.95151 3.14595 3.14677C2.95095 3.34206 2.95078 3.65871 3.14595 3.85388L5.29213 6.00006L3.14595 8.14624C2.95078 8.34141 2.95095 8.65806 3.14595 8.85335C3.34121 9.04861 3.65779 9.04861 3.85306 8.85335L5.99924 6.70717L8.14611 8.85404C8.34129 9.04905 8.65798 9.04898 8.85321 8.85404C9.04842 8.65883 9.04832 8.34221 8.85321 8.14693L6.70634 6.00006L8.85321 3.85319C9.04832 3.65792 9.04842 3.34129 8.85321 3.14608C8.65798 2.95114 8.34129 2.95107 8.14611 3.14608Z" fill="currentColor"/></svg>',
        "chevron_m.svg":
        ...
        "check_m.svg":
          '<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M11.1738 5.12131C11.3832 4.94158 11.699 4.96499 11.8789 5.17404C12.0586 5.3834 12.0352 5.69917 11.8262 5.87912L7.44043 9.64377C6.90283 10.1053 6.11571 10.1277 5.55273 9.69748L3.19629 7.89768C2.97687 7.73001 2.93488 7.41592 3.10254 7.1965C3.2702 6.97709 3.58429 6.93509 3.80371 7.10275L6.16015 8.90353C6.34779 9.04669 6.60996 9.03873 6.78906 8.88498L11.1738 5.12131Z" fill="currentColor"/></svg>',
        "check_s.svg":
          '<svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9.18554 3.11125C9.40024 2.93766 9.71503 2.97084 9.88867 3.18547C10.0623 3.40016 10.0291 3.71495 9.81445 3.88859L6.37011 6.67375C5.87644 7.07291 5.18493 7.11764 4.64355 6.78605L3.23925 5.92668C3.00392 5.78255 2.92939 5.4746 3.07324 5.23918C3.21737 5.00385 3.52531 4.92932 3.76074 5.07316L5.16601 5.93352C5.34642 6.0439 5.57671 6.02936 5.74121 5.89641L9.18554 3.11125Z" fill="currentColor"/></svg>'
      };
