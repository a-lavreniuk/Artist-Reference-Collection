...
export const INTERFACE_TOUR_STEPS: readonly InterfaceTourStep[] = [
  {
    ...
    placement: 'bottom',
    body:
      'Здесь находятся основные разделы ARC: «Библиотеки», «Коллекции» и\u00A0«Мудборд». Можно создать несколько библиотек — для\u00A0этого нажмите на\u00A0правую часть кнопки со\u00A0стрелкой',
    enabled: true
  },
  {
    id: 'search',
