...
[Скачать последнюю версию](https://github.com/a-lavreniuk/Artist-Reference-Collection/releases) • [Что нового?](#история-изменений)
...
1. Скачайте последнюю версию установщика из [Releases](https://github.com/a-lavreniuk/Artist-Reference-Collection/releases)
2. Запустите **ARC Setup 1.3.5.exe**
...
### v1.3.5 (31 декабря 2025)
- **Исправлены критические баги с подсчетом и фильтрацией**
  - Счетчики теперь показывают реальное количество файлов в системе сразу при запуске
  - Исправлена фильтрация по типу контента — при клике на "Видео" или "Изображения" карточки загружаются из БД
  - Исправлен поиск по меткам — теперь работает по всей базе данных
  - Оптимизирован поиск через использование индексов IndexedDB
  - Добавлена автоматическая загрузка всех карточек выбранного типа при активном фильтре

### v1.3.4 (декабрь 2025)
- Оптимизированы обновления данных во всех разделах
- Исправлена потеря позиции скролла при манипуляциях
- Улучшена производительность интерфейса
- Исправлены пустые состояния
- Добавлена обработка ошибок с автоматическим откатом

### v1.3.3 (декабрь 2025)
- Реализована пагинация загрузки карточек с автоматической подгрузкой
- Добавлена генерация трех размеров превью в формате WebP
- Реализована blur-up техника для плавной загрузки изображений
- Оптимизированы операции базы данных
- Добавлен in-memory кеш для изображений

### v1.3.2 (декабрь 2025)
- Кардинально улучшен алгоритм поиска дублей изображений
- Добавлено обнаружение повернутых дублей
- Исправлены критические баги
- Оптимизировано логирование

### v1.3.1 (6 декабря 2025)
