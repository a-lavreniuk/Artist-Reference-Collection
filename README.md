...
**База знаний:** [GitHub Wiki](https://github.com/a-lavreniuk/Artist-Reference-Collection/wiki) — пользовательские статьи, гайды для тестеров и документация дизайн-системы.
