 ...
 * @returns {string | null}
 */
export function resolveAbsoluteUrl(url, base = location.href) {
 ...
 * @returns {string | null}
 */
export function getMetaContent(property) {
 ...
 * @returns {string | null}
 */
export function pickLargestFromSrcset(srcset, base = location.href) {
 ...
 * @returns {string | null}
 */
export function pickLargestImageUrlFromElement(el) {
 ...
 * @returns {string | null}
 */
export function cleanPageTitle(title, suffixPatterns = []) {
