...
Закрывает цикл разработки: сохранить код на GitHub, влить тестовую ветку в `main`, удалить ветку, **затем** обновить или создать карточку в Buildin.
...
3. Статус → **«Готово»**; в теле страницы — секция **«Результат»** (ссылка на PR + 5–10 предложений).
...
- Старт задачи и `buildin_page_id` — **buildin-task-take** («возьми задачу»).
...
6. **buildin-task-finish**: статус «Готово», «Результат» с PR и выжимкой  
